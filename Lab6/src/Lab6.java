...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialf(GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, material1Shininess);


		int n = 12; // Liczba wierzchołków podstawy (12-kąta)
		float r = 5.5f; // Promień podstawy
		float h = 7.5f; // Wysokość piramidy
		// Współrzędne
		float y = -1.0f;
		float z, x;
